...
lệnh chỉ lấy khóa mới hơn local và đọc lại cửa sổ 3 ngày gần nhất để cập nhật các bản ghi
có thể bị sửa muộn. `--lookback-days` là cửa sổ kiểm tra lại, không phải lịch tự chạy:
